      ...
      <div className="relative max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <motion.h1
            ...
            className="text-6xl md:text-5xl font-bold bg-gradient-to-r from-gray-100 to-gray-300 text-transparent bg-clip-text mb-6"
          >
            Your Code Library: Find & Contribute Snippets
          </motion.h1>
          <motion.p
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            Find and use top-rated code snippets from the developer community
          </motion.p>
        </div>
